...
const App = () => {
  ...
  return (
    <div className="w-full flex flex-col items-start gap-7 px-[300px] py-10 text-[#b5c2d2]" style={{ background: "linear-gradient(125deg, #152034, #1c253c, #152034)" }}>
      ...
      <div className="w-full flex flex-col gap-5 rounded-xl p-[25px] border-solid border-2 border-[#27354a]">
        ...
        <div className="w-full grid grid-cols-2 gap-x-4 gap-y-3">
          ...
          <label className="flex flex-col gap-1 justify-center col-span-2">
